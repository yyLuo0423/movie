...
public class Clock {
  ...
  public static void setDaysAgo(int daysAgo) {
    setCurrentTime();
    DateTimeUtils.setCurrentMillisOffset(-Duration.ofDays((long) daysAgo).toMillis());
  }

  public static void setDaysAfter(int daysAfter) {
    setCurrentTime();
    DateTimeUtils.setCurrentMillisOffset(Duration.ofDays((long) daysAfter).toMillis());
  }

  public static void setDaysAfter(long now, int daysAfter) {
    DateTimeUtils.setCurrentMillisFixed(now + Duration.ofDays((long) daysAfter).toMillis());
  }

  public static void setMinutesAgo(int minutesAgo) {
    setCurrentTime();
    DateTimeUtils.setCurrentMillisOffset(-Duration.ofMinutes((long) minutesAgo).toMillis());
  }

  public static void setMinutesAfter(int minutesAfter) {
    setCurrentTime();
    DateTimeUtils.setCurrentMillisOffset(Duration.ofMinutes((long) minutesAfter).toMillis());
  }
